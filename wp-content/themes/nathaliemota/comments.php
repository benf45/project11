	...
	<div id="comments" class="comments-area max-w-base m-auto">
		...
		<?php if ( have_comments() ) : ?>
			<h2 class="comments-title">
				...
				if ( 1 === get_comments_number() ) {
					printf(
						...
						esc_html__( 'One thought on &ldquo;%s&rdquo;'),
			...
			<nav id="comment-nav-below" class="navigation" role="navigation">
				<h4 class="assistive-text section-heading"><?php esc_html_e( 'Comment navigation'); ?></h4>
				<div class="nav-previous"><?php previous_comments_link( esc_html__( '&larr; Older Comments') ); ?></div>
